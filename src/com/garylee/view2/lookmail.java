...
public class lookmail extends JFrame{
    ...
    public lookmail(){
        ImageIcon img = new ImageIcon("src/bg/lookmail.png");
        ...
        replybtn.setBounds(104,0, 99, 43);
        ...
        replybtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                new com.garylee.view2.writemail(email);
            }
        });
        mainbodytxt.setBounds(5, 188, 1035, 295);
...
//		mainbodytxt.setBorder(new LineBorder(new java.awt.Color(85,86,86), 1, false));
        ...
        areaPane.setBounds(5, 188, 1035, 295);
        ...
        lookbtn.setIcon(new ImageIcon("src/bg/look.png"));
        ...
        table.setBounds(10,543, 180, 135);
        ...
        tablePane.setBounds(10,543, 180, 135);
